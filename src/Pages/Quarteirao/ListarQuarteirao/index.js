...
// Funções utilitárias (mantidas, pois não afetam os ícones)
...
// Componente Item (Não corrigido, pois o erro não está aqui)
...
// Componente principal (Quarteiroes)
        ...
        if (item.type === 'mapa') {
            return (
                ...
                <TouchableOpacity 
                    ...
                    accessibilityLabel="Visualizar Mapa da Área" // Adicionado para acessibilidade
                >
                    <Icon name="map-o" size={font(3)} color="#fff" style={styles.mapaIcon} />
            ...
            return (
                ...
                >
                    <Icon name="map-marker" size={font(3.5)} color="#05419A" style={styles.quarteiraoIcon} />
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.areaTitleContainer}>
                {nomeArea && <Text style={styles.areaTitleText}>{nomeArea.toUpperCase()}</Text>}
            </View>
...
// Estilos (mantidos, pois estavam corretos)
